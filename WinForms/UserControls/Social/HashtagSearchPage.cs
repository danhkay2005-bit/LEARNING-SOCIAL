...
{
    /// <summary>
    /// ?? HASHTAG SEARCH PAGE - T�m ki?m b�i vi?t theo hashtag
    /// </summary>
    public class HashtagSearchPage : UserControl
    {
        ...
        private void InitializeControls()
        {
            ...
            btnBack = new Button
            {
                Text = "< Quay lai", // ? S?A: D�ng < thay v� ?, b? d?u
            ...
            lblStats = new Label
            {
                ...
                AutoSize = true,
                Font = new Font("Segoe UI", 10F, FontStyle.Regular), // ? Gi? nguy�n size
                ForeColor = Color.FromArgb(128, 128, 128) // ? M�u x�m ??m h?n
            };
        ...
        private async void LoadPostsAsync()
        {
            ...
            try
            {
                ...
                // 3. Update stats - ? S?A: ??n gi?n h�a text
                ...
                // 5. Hi?n th? k?t qu? - ? S?A: Font r� r�ng h?n
                if (!posts.Any())
                {
                ...
                foreach (var post in posts)
                {
                    if (_reactionService != null && _commentService != null)
                    {
                        ...
                        // ? Delay nh? ?? tr�nh DbContext conflict
                        await Task.Delay(50);
                    }
                }
            }
